# SmartHelmetEsp32
Embeeded software of the smarthelmet prototype that connects to the android application through ble and allows you to view live navigation, listen to music (a2dp), make / receive calls (hfp), and many more options
